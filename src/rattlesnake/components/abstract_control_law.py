...
class AbstractControlClass(ABC):
    ...
    def __init__(
        ...
        warning_levels : np.ndarray
            A real 2D numpy ndarray with dimensions frequency lines x control
            channels representing ASD levels at which the system is approaching
            abort.  Control law authors may wish to use this threshold to make
            changes in their control law.
        abort_levels : np.ndarray
            A real 2D numpy ndarray with dimensions frequency lines x control
            channels representing ASD levels at which the system will abort.
            Control law authors may wish to use this threshold to make
            changes in their control law to prevent producing a signal that
            would force the system to abort.
