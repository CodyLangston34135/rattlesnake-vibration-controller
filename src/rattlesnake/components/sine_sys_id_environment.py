...
class SineUI(AbstractSysIdUI):
    ...
    def update_run_plot(self, tone_index=None, channel_index=None, previous_tone=None, previous_channel=None, update_spec=True):
    ...
    def retrieve_metadata(self, netcdf_handle):
        ...
        for index, (spec_name, spec_group) in enumerate(group['specifications'].groups.items()):
            ...
            self.sine_tables[-1].clear_and_update_specification_table(
                frequency, amplitude, phase, sweep_type, sweep_rate, warning, abort,
                start_time, spec_name
            )
            ...
            (
                ...
                (
                    ...
                    (
                        ...
                        wrap(self.specification_phases[
                            ...,
                            :: self.data_acquisition_parameters.output_oversample
                            * self.plot_downsample,
                        ])*180/np.pi,
