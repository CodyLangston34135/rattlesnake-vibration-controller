...
from .abstract_hardware import HardwareAcquisition, HardwareOutput, HardwareMetadata, HardwareType
...
class SDynPySystemAcquisition(HardwareAcquisition):
    ...
    def create_response_channels(self, channel_data: List[Channel]):
        ...
        B_state = np.block([[np.zeros((ndofs, tdofs_input))], [np.linalg.solve(M, phi_excitation.T)]])
