from rattlesnake.components.abstract_sysid_environment import AbstractSysIdMetadata, AbstractSysIdUI, AbstractSysIdEnvironment
import openpyxl
...
class DummyAbstractSysIdUI(AbstractSysIdUI):
    def __init__(self, environment_name, environment_command_queue, controller_communication_queue, log_file_queue, system_id_tabwidget):
        super().__init__(environment_name, environment_command_queue, controller_communication_queue, log_file_queue, system_id_tabwidget)
