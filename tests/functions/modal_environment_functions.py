...
from rattlesnake.components.data_collector import AcquisitionType, Acceptance, TriggerSlope, Window, DataCollectorCommands
from rattlesnake.components.spectral_processing import AveragingTypes, Estimator, SpectralProcessingCommands
...
def create_signal_generator_dict():
    signal_generator_dict = {0: ('none', 'rattlesnake.components.modal_environment.PseudorandomSignalGenerator'),
...
def create_modal_commands_dict():
    modal_commands_dict = {0: ModalCommands.START_CONTROL,
...
def create_environment_template_calls():
    environment_template_calls = [mock.call(1,1,'Control Type'),
                                  mock.call(1,2,'Modal'),
                                  ...
                                  mock.call(8,2,'# Exponential Window Value at the end of the measurement frame (0.5 or 50%, not 50)'),
                                  ...
                                  mock.call(15,2,'# Level to use to trigger the test as a fraction of the total range of the channel (0.5 or 50%, not 50)'),
                                  mock.call(16,1,'Hysteresis Level'),
                                  mock.call(16,2,'# Level that a channel must fall below before another trigger can be considered (0.5 or 50%, not 50)'),
                                  mock.call(17,1,'Hysteresis Frame Fraction'),
                                  mock.call(17,2,'# Fraction of the frame that a channel maintain hysteresis condition before another trigger can be considered (0.5 or 50%, not 50)'),
                                  mock.call(18,1,'Signal Generator Type'),
                                  mock.call(18,2,'# One of "None", "Random", "Burst Random", "Pseudorandom", "Chirp", "Square", or "Sine"'),
                                  mock.call(19,1,'Signal Generator Level'),
                                  mock.call(19,2,'# RMS voltage level for random signals, Peak voltage level for chirp, sine, and square pulse'),
                                  mock.call(20,1,'Signal Generator Frequency 1'),
                                  mock.call(20,2,'# Minimum frequency for broadband signals or frequency for sine and square  pulse'),
                                  mock.call(21,1,'Signal Generator Frequency 2'),
                                  mock.call(21,2,'# Maximum frequency for broadband signals.  Ignored for sine and square pulse'),
                                  mock.call(22,1,'Signal Generator On Fraction'),
                                  mock.call(22,2,'# Fraction of time that the burst or square wave is on (0.5 or 50%, not 50)'),
                                  mock.call(23,1,'Wait Time for Steady State'),
                                  mock.call(23,2,'# Time to wait after output starts to allow the system to reach steady state'),
...
def create_environment_collector_metadata_calls():
    metadata_call = [mock.call(1, [1, 2], [], AcquisitionType.FREE_RUN, Acceptance.AUTOMATIC,
                     None, 0.0, 0, TriggerSlope.POSITIVE, 0.01, 0.02, 0, 0.0, 10, 
                     Window.RECTANGLE, response_transformation_matrix = None, 
                     reference_transformation_matrix = None, window_parameter_2 = -10/np.log(0.25))]
    return metadata_call


def create_environment_spectral_metadata_calls():
    metadata_call = [mock.call(AveragingTypes.LINEAR, 30, 0.1, Estimator.H1, 2, 0,
                               204.8, 2048, 6, compute_cpsd=False, compute_apsd=True)]
    return metadata_call


def create_environment_signal_metadata_calls():
    metadata_call = [mock.call(samples_per_write = 102400, level_ramp_samples = 1, 
                               output_transformation_matrix = None, disabled_signals = [0])]
    return metadata_call


def create_environment_start_calls(mock_collect, mock_signal, mock_siggen, mock_spectral):
    environment_name = "Environment_name"
    start_calls = [mock.call(environment_name, (DataCollectorCommands.FORCE_INITIALIZE_COLLECTOR, mock_collect())),
                   mock.call(environment_name, (DataCollectorCommands.SET_TEST_LEVEL, (0, 1))),
                   mock.call(environment_name, (SignalGenerationCommands.INITIALIZE_PARAMETERS, mock_signal())),
                   mock.call(environment_name, (SignalGenerationCommands.INITIALIZE_SIGNAL_GENERATOR, mock_siggen())),
                   ...
                   mock.call(environment_name, (SpectralProcessingCommands.INITIALIZE_PARAMETERS, mock_spectral())),
