from rattlesnake.components.output import OutputProcess, output_process
from rattlesnake.components.utilities import VerboseMessageQueue, QueueContainer, Channel, DataAcquisitionParameters
...
def test_output_process_initialize_data_acquisition(mock_log, hardware, hardware_idx, output_process_obj, data_acquisition_parameters, hardware_dict):
    ...
    with mock.patch(hardware_dict[hardware_idx]) as mock_hardware:
        ...
        mock_hardware().set_up_data_output_parameters_and_channels.assert_called_with(data_acquisition_parameters, data_acquisition_parameters.channel_list)
...
if __name__ == "__main__":
    ...
    output_process_obj = OutputProcess("Process Name", queue_container, environments, mp.Value('i', 0))
